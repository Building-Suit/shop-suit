...
// --- Query Types ---
export interface ApiQueryOptions<TData, TError = unknown> {
...
export interface ApiQueryResult<TData, TError = unknown> {
...
export type QueryAdapter = <TData, TError>(
...
export type MutationAdapter = <TData, TVariables, TError>(
